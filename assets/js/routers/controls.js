...
jQuery(function() {
  var alert_modal, button_modal, grid_modal, header_modal, pagination_modal, table_modal, _ref;
  ...
  return app.Controller = (function(_super) {
    ...
    Controller.prototype.headerModal = function() {
      return header_modal.show();
    };
